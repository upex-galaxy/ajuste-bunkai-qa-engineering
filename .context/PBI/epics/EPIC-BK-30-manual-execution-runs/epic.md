...
| [BK-36](https://jira.upexgalaxy.com/browse/BK-36) | TMS-Run Execution | Abort a run in progress with a reason | 8 | Medium | Ready For QA |
...
| [BK-39](https://jira.upexgalaxy.com/browse/BK-39) | TMS-Run Execution | Finish a run with a final verdict | 5 | Medium | QA Approved |
