...
**Status:** Planning | **Stories:** 5 | **Points:** 31
...
**Status:** Planning | **Stories:** 6 | **Points:** 32
...
- [BK-147](https://jira.upexgalaxy.com/browse/BK-147) App Shell | Open ATCs and Tests as tabs with a persistent explorer _(5 pts, Ready For QA)_
...
- [BK-17](https://jira.upexgalaxy.com/browse/BK-17) Jira Import | Pull Jira issues by JQL _(5 pts, BLOCKED)_
...
- [BK-20](https://jira.upexgalaxy.com/browse/BK-20) TMS-ATC Search | Search and autocomplete ATCs _(5 pts, In Review)_
...
- [BK-34](https://jira.upexgalaxy.com/browse/BK-34) TMS-Run Execution | Start a manual run in a chosen environment _(8 pts, Ready For Dev)_
- [BK-35](https://jira.upexgalaxy.com/browse/BK-35) TMS-Run Execution | Mark each step pass, fail, or block _(1 pts, Estimation)_
- [BK-36](https://jira.upexgalaxy.com/browse/BK-36) TMS-Run Execution | Abort a run in progress with a reason _(1 pts, Estimation)_
...
- [BK-39](https://jira.upexgalaxy.com/browse/BK-39) TMS-Run Execution | Finish a run with a final verdict _(5 pts, Ready For Dev)_
...
- [BK-46](https://jira.upexgalaxy.com/browse/BK-46) TMS-Coverage | Surface untested ACs and modules with not-run filter _(- pts, Shift-Left QA)_
